...
START_TEST(test_pop_back)
{
    ...
    FILE *file_test_in = fopen("./unit_tests/tests/pop_back_pos_01_in.txt", "r");
    FILE *file_test_out = fopen("./unit_tests/tests/pop_back_pos_01_out.txt", "r");
