...
START_TEST(test_sort)
{
    ...
    FILE *file_test_in = fopen("./unit_tests/tests/sort_pos_01_in.txt", "r");
    FILE *file_test_out = fopen("./unit_tests/tests/sort_pos_01_out.txt", "r");
    ...
    head_test_in = sort(head_test_in, compare);
